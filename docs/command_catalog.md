...
This catalog preserves the detailed command surface for research, deployment,
and product workflows. The README keeps the public-facing first-run path short;
this page is the deeper operator/developer reference.
...
## No-Download Product Quickstart
...
## C-MAPSS Data, EDA, And Classical Baselines
...
## C-MAPSS Sequence Models And Phase 2 Comparisons
...
## Deployment Evidence And Serving
...
## App Database, Fleet Registry, And Operations Commands
