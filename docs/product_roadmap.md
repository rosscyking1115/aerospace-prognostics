...
attach observed RUL outcomes, export persisted prediction rows and run evidence
bundles, append operator decisions, display an audit log for each run,
...
import, and run evidence export also available in the console.
