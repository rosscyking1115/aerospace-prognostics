...
| Optimizer | Adam |
| Loss | MSE by default; optional `nasa_surrogate`, MSE+NASA blended losses, asymmetric late-weighted MSE losses, target-weighted MSE, mini-batch monotonic penalties, and unit-batch monotonic penalties |
| Random seed | 42 |
...
Asymmetric late-weighted MSE plus monotonic penalty:

```powershell
uv run aerospace-prognostics phase2-cmapss --data-dir data/raw/cmapss --artifact-dir artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1 --subsets FD001 --models transformer --epochs 40 --batch-size 256 --hidden-sizes 32 --learning-rates 0.001 --validation-horizon 30 --checkpoint-policy validation_nasa --training-loss asymmetric_mse_late_w1p5_monotonic_w0p1
uv run aerospace-prognostics phase2-cmapss-verify-manifest --manifest artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/phase2_run_manifest.json --output-markdown artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/phase2_manifest_audit.md
uv run aerospace-prognostics cmapss-calibrate-deep-predictions --method predicted_bin_nasa_shift --shrinkage-strength 500 --nasa-shift-max 10 --nasa-shift-step 1 --calibration-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_validation_selection_predictions.csv --predictions-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_predictions.csv --output-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_predictions_predicted_bin_nasa_shift_s500_calibrated.csv --output-calibration-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibration.csv --output-diagnostics-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_diagnostics.csv --output-rul-bins-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_rul_bins.csv --output-unit-diagnostics-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_unit_diagnostics.csv --output-markdown artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_diagnostics.md
```

The first monotonic-penalty check verified with `status=ok` across 23 checked artifacts. It keeps the same selected epoch as the asymmetric-loss run and gives a small official-test improvement: raw RMSE 14.118865 and NASA score 278.179058, versus the raw asymmetric run's RMSE 14.154401 and NASA score 279.487610. The predicted-bin NASA-shift calibration with shrinkage 500 improves the monotonic run to RMSE 14.246672 and NASA score 271.486206, narrowly ahead of the previous best calibrated asymmetric result at RMSE 14.267129 and NASA score 272.578820. The monotonicity diagnostic is more mixed: validation-selection violation rate stays unchanged at 0.481709, while mean violation magnitude drops from 3.051478 to 3.005264 and max violation magnitude drops from 24.034863 to 23.861626. This means the mini-batch monotonic penalty is a useful small regularizer, not yet a strong physics-informed constraint. It is safe to carry into focused FD001 checks, but the next true physics-informed step should enforce unit-level trajectories more directly than shuffled mini-batches can.

Unit-batch asymmetric late-weighted MSE plus monotonic penalty:

```powershell
uv run aerospace-prognostics phase2-cmapss --data-dir data/raw/cmapss --artifact-dir artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1 --subsets FD001 --models transformer --epochs 40 --batch-size 256 --hidden-sizes 32 --learning-rates 0.001 --validation-horizon 30 --checkpoint-policy validation_nasa --training-loss asymmetric_mse_late_w1p5_unit_monotonic_w0p1
uv run aerospace-prognostics phase2-cmapss-verify-manifest --manifest artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/phase2_run_manifest.json --output-markdown artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/phase2_manifest_audit.md
uv run aerospace-prognostics cmapss-calibrate-deep-predictions --method predicted_bin_nasa_shift --shrinkage-strength 500 --nasa-shift-max 10 --nasa-shift-step 1 --calibration-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_validation_selection_predictions.csv --predictions-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_predictions.csv --output-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_predictions_predicted_bin_nasa_shift_s500_calibrated.csv --output-calibration-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibration.csv --output-diagnostics-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_diagnostics.csv --output-rul-bins-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_rul_bins.csv --output-unit-diagnostics-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_unit_diagnostics.csv --output-markdown artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_prediction_predicted_bin_nasa_shift_s500_calibrated_diagnostics.md
```

The unit-batch monotonic check verified with `status=ok` across 23 checked artifacts. It trained one sorted engine trajectory per batch and selected epoch 40. That did make the validation-selection trajectory steps smoother by magnitude: violation rate stayed at 0.481709, but mean violation magnitude improved from 3.005264 to 2.924915 and max violation magnitude improved from 23.861626 to 21.610466 versus the mini-batch monotonic run. The cost is too high for FD001 promotion: official-test RMSE worsened to 14.770920 and NASA score to 320.509955; the same predicted-bin NASA-shift calibration only recovered the model to RMSE 14.624847 and NASA score 310.402859. The conclusion is clear enough for now: full unit-trajectory batching is useful evidence that the penalty can smooth predictions, but it changes the optimization dynamics too much. Keep the mini-batch monotonic variant as the current best deep regularizer and treat stronger physics-informed work as a separate health-index or post-processing constraint, not simply bigger monotonic batches.

FD001 deep leaderboard refresh:

```powershell
uv run aerospace-prognostics cmapss-compare-rul-results --baseline-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_hgb_policy_baseline.csv --candidate-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_compare.csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_compare.csv --prediction-csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_monotonic_w0p1/results/cmapss_deep_predictions_predicted_bin_nasa_shift_s500_calibrated.csv artifacts/phase2_fd001_transformer_h32_40e_asymmetric_unit_monotonic_w0p1/results/cmapss_deep_predictions_predicted_bin_nasa_shift_s500_calibrated.csv --prediction-model-suffixes predicted_bin_nasa_shift_s500 predicted_bin_nasa_shift_s500 --prediction-label phase2_calibrated --output-csv artifacts/phase2_fd001_unit_monotonic_leaderboard/cmapss_fd001_unit_monotonic_leaderboard.csv --output-markdown artifacts/phase2_fd001_unit_monotonic_leaderboard/cmapss_fd001_unit_monotonic_leaderboard.md
```

The comparison command now accepts prediction CSVs in addition to result tables, summarizing each prediction file into RMSE and NASA score before ranking. That keeps calibrated candidates in the same leaderboard without hand-built intermediate result CSVs. The refreshed FD001 leaderboard ranks HGB first; the best deep candidate remains the mini-batch monotonic asymmetric-loss Transformer plus NASA-shift calibration. The unit-batch monotonic check ranks behind both raw and calibrated mini-batch monotonic rows:
...
| 2 | `phase2_calibrated` | Mini-batch monotonic asymmetric Transformer + NASA-shift s500 | 14.246672 | 271.486206 | 18.020884 |
| 3 | `phase2_deep` | Mini-batch monotonic asymmetric Transformer | 14.118865 | 278.179058 | 24.713736 |
| 4 | `phase2_calibrated` | Unit-batch monotonic asymmetric Transformer + NASA-shift s500 | 14.624847 | 310.402859 | 56.937536 |
| 5 | `phase2_deep` | Unit-batch monotonic asymmetric Transformer | 14.770920 | 320.509955 | 67.044632 |
...
| Phase 2 monotonic asymmetric-loss check | `compare_transformer_h32_lr0p001_transformer_w30_e40_d32_h4_l1_ff64_loss_asymmetric_mse_late_w1p5_monotonic_w0p1_best_e38` | 38 | 15.043493 | 10385.988676 | 14.118865 | 278.179058 |
| Phase 2 monotonic asymmetric-loss NASA-shift diagnostic | `compare_transformer_h32_lr0p001_transformer_w30_e40_d32_h4_l1_ff64_loss_asymmetric_mse_late_w1p5_monotonic_w0p1_best_e38_predicted_bin_nasa_shift_s500` | 38 | 15.043493 | 10385.988676 | 14.246672 | 271.486206 |
...
| Phase 2 unit-batch monotonic asymmetric-loss check | `compare_transformer_h32_lr0p001_transformer_w30_e40_d32_h4_l1_ff64_loss_asymmetric_mse_late_w1p5_unit_monotonic_w0p1_best_e40` | 40 | 15.425540 | 10573.895582 | 14.770920 | 320.509955 |
| Phase 2 unit-batch monotonic asymmetric-loss NASA-shift diagnostic | `compare_transformer_h32_lr0p001_transformer_w30_e40_d32_h4_l1_ff64_loss_asymmetric_mse_late_w1p5_unit_monotonic_w0p1_best_e40_predicted_bin_nasa_shift_s500` | 40 | 15.425540 | 10573.895582 | 14.624847 | 310.402859 |
...
- Use validation-selection errors by unit, end cycle, RUL range, and monotonicity as the first decision surface for calibration and tail-sensitive modelling before rechecking official-test behavior; affine and predicted-bin residual checks improved RMSE but failed the NASA-score tradeoff, asymmetric late-weighted MSE improved the best uncalibrated deep NASA score to 279.487610, and pairing that model with predicted-bin NASA-shift calibration improved the best deep NASA score to 272.578820. The mini-batch monotonic loss became the current best calibrated deep FD001 row, while unit-batch monotonic training reduced violation magnitudes but worsened raw and calibrated NASA score. Future monotonic work should move toward health-index modelling or calibrated post-processing rather than simply enlarging the training batch trajectory.
